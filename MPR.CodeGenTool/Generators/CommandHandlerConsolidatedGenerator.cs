...
namespace MPR.CodeGenTool.Generators
{
    public class CommandHandlerConsolidatedGenerator
    {
        ...
        private static void GenerateHandlerFile(EntityModel entity, string solutionName, string outputPath)
        {
            ...
            var templatePath = Path.Combine(baseDir, "Templates", "Application", "Commands", "CommandHandlersConsolidated.scriban");
            ...
            Console.WriteLine($"✅ CommandHandlers consolidados generados para: {entity.Name}");
        }
    }
}