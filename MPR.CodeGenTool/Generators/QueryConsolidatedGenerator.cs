    ...
    public class QueryConsolidatedGenerator
    {
        public static void Generate(string infraAssemblyPath, string solutionName, string outputPath)
        {
            ...
            foreach (var entity in metadataList)
            {
                ...
                GenerateQueries(entityModel, solutionName, outputPath);
            }
        }

        private static void GenerateQueries(EntityModel entity, string solutionName, string outputPath)
        {
            ...
            Console.WriteLine($"✅ Consultas CQRS generadas para: {entity.Name}");
        }
